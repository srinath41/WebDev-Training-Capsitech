...
function DetailCard({weather_icon,data}){
    ...
    return (
        <div className="container p-4 flex lg:flex-row flex-col items-center justify-center h-1/3 mb-auto">
            <div className="my-auto flex flex-col lg:items-start items-center">
            <p className="font-bold text-5xl text-cyan-600 mb-2">{Math.round(main.temp)}&deg;C</p>
